    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <div className="flex items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="bg-blue-900/20 backdrop-blur-sm rounded-xl p-6 border border-blue-700/30 mb-6">
            <h3 className="text-lg font-semibold text-blue-300 mb-3">Demo Credentials</h3>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-300">Email:</span>
                <span className="text-blue-300 font-mono">demo@quizgame.com</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-300">Password:</span>
                <span className="text-blue-300 font-mono">demo123</span>
              </div>
            </div>
            <button
          ...
          <div className="bg-gray-800/70 backdrop-blur-sm rounded-xl p-8 border border-gray-700 shadow-2xl">
            ...
            <div className="mt-8 pt-6 border-t border-gray-700">
              <h4 className="text-sm font-medium text-gray-400 mb-4">Other Sample Accounts:</h4>
              <div className="grid grid-cols-1 gap-2 text-xs">
                <div className="flex justify-between text-gray-500">
                  <span>admin@quizgame.com</span>
                  <span>admin123</span>
                </div>
                <div className="flex justify-between text-gray-500">
