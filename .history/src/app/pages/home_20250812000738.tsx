              ...
              <div key={contest.id} className="bg-gray-800/70 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700 hover:border-purple-500/50 transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-purple-500/10 group">
                <div className="relative">
                  ...
                  <div className="p-5 relative z-10">
                    ...
                    <Link href={`/pages/contests`} className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-3 rounded-lg font-bold transition-all duration-200 transform group-hover:scale-105 shadow-lg group-hover:shadow-purple-500/30">
                      Join Contest
                    </Link>
                  </div>
                </div>
