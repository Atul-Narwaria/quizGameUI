        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/pages/register" className="bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold py-2 px-6 rounded-full">
                Sign Up
              </Link>
            </div>
          </nav>
      ...
      <div className="flex items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="bg-green-900/20 backdrop-blur-sm rounded-xl p-6 border border-green-700/30">
            <h3 className="text-lg font-semibold text-green-300 mb-2">Demo Registration</h3>
            <p className="text-sm text-gray-300">
              This is a demo app. You can register with any email and it will create a mock account for testing purposes.
            </p>
          </div>
          ...
          <div className="bg-gray-800/70 backdrop-blur-sm rounded-xl p-8 border border-gray-700 shadow-2xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-extrabold">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Create Account</span>
              </h2>
              <p className="mt-2 text-gray-400">Join QuizGame and start competing today</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start">
                <input
                  ...
                  onChange={handleInputChange}
                  className="mt-1 h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-700 rounded bg-gray-900"
                />
                <label htmlFor="agreeToTerms" className="ml-2 block text-sm text-gray-300">
                  I agree to the{' '}
                  <Link href="/pages/terms" className="text-purple-400 hover:text-purple-300">
                    Terms and Conditions
                  </Link>{' '}
                  and{' '}
                  <Link href="/pages/privacy" className="text-purple-400 hover:text-purple-300">
                    Privacy Policy
                  </Link>
                </label>
              </div>
              ...
              <div className="text-center">
                <p className="text-gray-400">
                  ...
                  <Link href="/pages/login" className="text-purple-400 hover:text-purple-300 font-medium transition-colors">
                    Sign in here
                  </Link>
                </p>
              </div>
