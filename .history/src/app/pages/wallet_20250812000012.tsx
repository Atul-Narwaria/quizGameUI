      ...
      <header className="sticky top-0 z-50 backdrop-blur-lg bg-black/70 border-b border-gray-800">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="flex items-center space-x-8">
            <Link href="/pages/home" className="text-gray-300 hover:text-white transition-colors duration-200 font-medium">Home</Link>
      ...
      <div className="relative pt-16 pb-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-md bg-gradient-to-r from-purple-600 via-pink-500 to-yellow-400 rounded-2xl shadow-2xl border-4 border-purple-700 p-0 relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-full opacity-20 pointer-events-none"
                style={{
                  background: 'url(/images/card-bg.svg) center/cover no-repeat'
                }}
              />
              <div className="relative z-10 p-8 flex flex-col items-center">
                <div className="flex items-center justify-between w-full mb-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xl font-bold text-white drop-shadow">QuizGame Wallet</span>
                  </div>
                  <span className="bg-black/30 text-white text-xs px-3 py-1 rounded-full font-semibold">Active</span>
                </div>
                <div className="w-full text-center">
                  <p className="text-gray-200 text-sm mb-2">Available Balance</p>
                  <p className="text-5xl font-extrabold text-white drop-shadow-lg tracking-wide mb-4">
                ...
                <div className="flex w-full justify-center gap-4 mt-4">
                  <button
                    ...
                    className="px-6 py-2 bg-white/20 hover:bg-white/30 text-white font-semibold rounded-xl shadow-lg transition-all duration-200 backdrop-blur-lg border border-white/30"
                  >
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-black/30 hover:bg-black/40 text-white font-semibold rounded-xl shadow-lg transition-all duration-200 border border-white/30"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 inline mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* End Attractive Wallet Card */}
          {/* ...existing code for navigation tabs... */}
          <div className="bg-gray-800/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-2xl border border-gray-700 mt-8">
            <div className="px-4 py-5 sm:px-6 flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="mt-6 md:mt-0 flex flex-col items-center md:items-end">
                <div className="text-center md:text-right">
                  ...
                  <p className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-500">₹{walletData.balance.toFixed(2)}</p>
                </div>
                <div className="mt-4 flex space-x-4">
                  <button 
                    onClick={() => setShowAddMoneyModal(true)}
                    className="px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-green-500/30 flex items-center"
                  >
            ...
            <div className="border-t border-gray-700">
              <nav className="flex overflow-x-auto">
                ...
                <button
                  ...
                  className={`px-6 py-4 text-sm font-medium whitespace-nowrap ${activeTab === 'transactions' ? 'text-purple-400 border-b-2 border-purple-500' : 'text-gray-400 hover:text-white'}`}
                >
                  Transactions
                </button>
                <button
                  onClick={() => setActiveTab('payment-methods')}
                  className={`px-6 py-4 text-sm font-medium whitespace-nowrap ${activeTab === 'payment-methods' ? 'text-purple-400 border-b-2 border-purple-500' : 'text-gray-400 hover:text-white'}`}
                >
                  Payment Methods
                </button>
              </nav>
