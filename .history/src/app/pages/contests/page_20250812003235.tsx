...
const contests = [
  {
    ...
    difficulty: 'easy',
    status: 'live',
    description: 'Quick 10-question quiz to test your general knowledge!',
    questionCount: 10,
  },
  {
    id: 'contest2',
    title: 'Standard Quiz Battle',
    entryFee: 25,
    totalPrize: 2500,
    participants: 80,
    maxParticipants: 300,
    ...
    difficulty: 'medium',
    status: 'live',
    description: 'Standard 25-question quiz covering multiple topics!',
    questionCount: 25,
  },
  {
    id: 'contest3',
    title: 'Extended Quiz Marathon',
    entryFee: 50,
    totalPrize: 5000,
    participants: 60,
    maxParticipants: 250,
    ...
    difficulty: 'medium',
    status: 'upcoming',
    description: 'Extended 50-question quiz for serious quiz enthusiasts!',
    questionCount: 50,
  },
  {
    id: 'contest4',
    title: 'Ultimate Quiz Championship',
    entryFee: 100,
    totalPrize: 10000,
    participants: 30,
    maxParticipants: 100,
    startTime: '2023-07-18T17:00:00',
    endTime: '2023-07-18T20:00:00',
    category: 'mixed',
    difficulty: 'hard',
    status: 'upcoming',
    description: 'Ultimate 100-question quiz championship for quiz masters!',
    questionCount: 100,
  },
];
              ...
              <div key={contest.id} className="bg-gray-800/70 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700 hover:border-purple-500/50 transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-purple-500/10 group">
                <div className="relative">
                  ...
                  <div className="p-6 relative z-10">
                    ...
                    <div className="mb-4">
                      <div className="flex justify-between items-center">
                        <div>
                          ...
                          <p className="font-bold text-lg text-blue-400">{contest.questionCount}Q</p>
                        </div>
                        <div>
                    ...
                    {/* Action Button */}
                    <Link 
                      href={`/pages/quiz?questions=${contest.questionCount}&category=${contest.category}&difficulty=${contest.difficulty}`} 
                      className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-3 rounded-lg font-bold transition-all duration-200 transform group-hover:scale-105 shadow-lg group-hover:shadow-purple-500/30 block text-center"
                    >
                      {contest.status === 'live' ? 'Start Quiz' : 'Register'}
                    </Link>
                  </div>
                </div>
              </div>
